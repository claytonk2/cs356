...
////  Havenly
////
////  Created by Benjamin Walter on 8/2/18.
...
////        let dic = service.store(note: Note(date: DateTimePicker!.date as NSDate, text: ReminderTextBox.text!, tags: ""))
...
//        }
//
//        //userModel.user.addReminder(rem: rem)
//
