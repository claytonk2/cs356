...
//        self.topGraph = type
//        self.getData(top: true, unitString: type)
//    }
//    func setBottom(type: String){
//        self.bottomGraph = type
//        self.getData(top: false, unitString: type)
//    }
...
//        self.BPTop = top
//    }
//    func getData(top: Bool, unitString: String){
...
//            getter.getBloodGlucose(top: top)//topSample = userModel.user.getBloodGlucose() as! [HKSample]
//
//        }//,"Blood Pressure","Calories","Carbs","Heart Rate","Medication"
//        else if ("Calories" == unitString){
//            getter.getCalories(top: top)//topSample = userModel.user.getCalories() as! [HKSample] // dont have this info stored?
//
//        }
//        else if ("Steps" == unitString){
//            getter.getSteps(top: top)//topSample = userModel.user.getCalories() as! [HKSample] // dont have this info stored?
//
//        }
//        else if ("Blood Pressure" == unitString){
//            getter.getBloodPreasure(top: top)//topSample = userModel.user.bloodPressure as! [HKSample] // dont have this info stored?
//
//            self.BPTop = top
//        }
//        else if ("Carbs" == unitString){
//            getter.getCarbs(top: top)//topSample = userModel.user.getCarbs() as! [HKSample] // dont have this info stored?
//
//        }
//        else if ("Heart Rate" == unitString){
//            getter.getHeartRate(top: top)//topSample = userModel.user.getHeartRate() as! [HKSample]
//        }
